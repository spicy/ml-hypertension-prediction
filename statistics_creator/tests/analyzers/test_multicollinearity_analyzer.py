...
from statistics_creator.analyzers.correlation_multicollinearity_analyzer import (
...
class TestMulticollinearityAnalyzer(unittest.TestCase):
    def setUp(self):
        ...
        self.test_data = pd.DataFrame(
            {"A": [1, 2, 3, 4, 5], "B": [2, 4, 6, 8, 10], "C": [1, 2, 3, 4, 5]}
        )
    ...
    def test_analyze_perfect_collinearity(self):
        ...
        self.assertTrue(
            all(result["VIF"] > 1000)
        )  # Very high VIF for perfect collinearity
